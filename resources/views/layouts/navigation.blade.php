...
<nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Chwilówki</a>
            </div>
          </div>
        </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Chwilówki</a>
      </div>
    </div>
